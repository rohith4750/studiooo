    ...
    <footer className="bg-neutral-900 text-neutral-300 border-t border-neutral-800 text-xs py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Col 4: Staff Portal */}
          <div className="space-y-3">
            <h4 className="text-white font-bold text-xs uppercase tracking-wider">Studio Staff Access</h4>
            <p className="text-[11px] text-neutral-400">
              Access the internal R2R CRM & Management Dashboard.
            </p>
            <Link
              href="/"
              className="inline-flex items-center space-x-2 px-4 py-2 rounded-xl bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 text-white font-semibold transition"
            >
